...
// Persisted as JSON alongside a PID file under ~/.agentsworkhub/schedulers/<name>/.
...
type SchedulerState struct {
	dir  string // e.g. ~/.agentsworkhub/schedulers/<name>
	name string
}
...
func schedulersBaseDir() (string, error) {
	...
	return filepath.Join(home, ".agentsworkhub", "schedulers"), nil
}
